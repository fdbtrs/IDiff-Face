...
__all__ = ['iresnet18', 'iresnet34', 'iresnet50', 'iresnet50_2', 'iresnet100']
...
def iresnet50_2(pretrained=False, progress=True, **kwargs):
    kwargs["width_per_group"] = 64 * 2
    return _iresnet('iresnet50_2', IBottleneck, [3, 4, 14, 3], pretrained,
                    progress, **kwargs)
